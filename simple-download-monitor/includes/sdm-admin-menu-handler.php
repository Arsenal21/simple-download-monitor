...
function sdm_create_settings_page()
{
        ...
        <div id="poststuff" class="sdm-settings-grid sdm-sidebar-cont">
            <div class="postbox" style="min-width: inherit;">
                <h3 class="hndle"><label
                            for="title"><?php _e('Plugin Documentation', 'simple-download-monitor'); ?></label></h3>
                <div class="inside">
            ...
            <div class="postbox" style="min-width: inherit;">
                ...
                <div class="inside">
                    ...
                    <div class="sdm-stars-container">
                        <a href="https://wordpress.org/support/plugin/simple-download-monitor/reviews/?filter=5"
                           target="_blank">
            ...
            <div class="postbox" style="min-width: inherit;">
                <h3 class="hndle"><label
                            for="title"><?php _e('Our Other Plugins', 'simple-download-monitor'); ?></label></h3>
                <div class="inside">
    ...
    <div style="background: none repeat scroll 0 0 #FFF6D5;border: 1px solid #D1B655;color: #3F2502;margin: 10px 0;padding: 5px 5px 5px 10px;text-shadow: 1px 1px #FFFFFF;">
        <p>
            ...
            <a href="https://wordpress.org/plugins/wp-express-checkout/"
               target="_blank"><?php _e('WP Express Checkout', 'simple-download-monitor'); ?></a>
            or <a href="https://wordpress.org/plugins/stripe-payments/"
                  target="_blank"><?php _e('Stripe Payments', 'simple-download-monitor'); ?></a>
            or
            <a href="https://www.tipsandtricks-hq.com/wordpress-estore-plugin-complete-solution-to-sell-digital-products-from-your-wordpress-blog-securely-1059"
               target="_blank"><?php _e('WP eStore', 'simple-download-monitor'); ?></a> Plugin.
        </p>
    </div>
    ...
    if (isset($_GET['action'])) {
        switch ($_GET['action']) {
            ...
            case 'sdm-logs-export':
                include_once(WP_SIMPLE_DL_MONITOR_PATH . 'includes/admin-side/sdm-admin-export-logs-page.php');
...
function sdm_handle_logs_main_tab_page()
{
    ...
    <div id="poststuff">
        <div id="post-body">
            ...
            <div class="postbox">
                <h3 class="hndle"><label
                            for="title"><?php _e('Reset Download Log Entries', 'simple-download-monitor'); ?></label>
                </h3>
                <div class="inside">
                    <form method="post" action=""
                          onSubmit="return confirm('Are you sure you want to reset all the log entries?');">
                        <div class="submit">
                            <input type="submit" class="button" name="sdm_reset_log_entries"
                                   value="<?php _e('Reset Log Entries', 'simple-download-monitor'); ?>"/>
                    ...
                    <form method="post" action=""
                          onSubmit="return confirm('Are you sure you want to trim log entries?');">
                        <div class="submit">
                            Delete Log Entries Older Than <input name="sdm_trim_log_entries_days" type="text" size="4"
                                                                 value="<?php echo $trim_log_entries_days_default_val; ?>"/>
                            Days
                            <input type="submit" class="button" name="sdm_trim_log_entries"
                                   value="<?php _e('Trim Log Entries', 'simple-download-monitor'); ?>"/>
...
function sdm_create_stats_page()
{
    ...
    if (isset($main_opts['admin_no_logs'])) {
        ?>
        <div class="notice notice-warning"><p><b>Download Logs are disabled in <a
                            href="?post_type=sdm_downloads&page=settings">plugin settings</a>. Please enable Download
                    Logs to see current stats.</b></p></div>
        <?php
    }
                ...
                <div class="postbox">
                    ...
                    <div class="inside">
                        <form id="sdm_choose_date" method="post">
                            ...
                            <?php _e('Start Date: ', 'simple-download-monitor'); ?><input type="text" class="datepicker"
                                                                                          name="sdm_stats_start_date"
                                                                                          value="<?php echo $start_date; ?>">
                            <?php _e('End Date: ', 'simple-download-monitor'); ?><input type="text" class="datepicker"
                                                                                        name="sdm_stats_end_date"
                                                                                        value="<?php echo $end_date; ?>">
                            <p id="sdm_date_buttons">
                                <button type="button" data-start-date="<?php echo date('Y-m-01'); ?>"
                                ...
                                <button button type="button" data-start-date="<?php echo date('Y-01-01'); ?>"
                                ...
                                <button button type="button" data-start-date="<?php echo "1970-01-01"; ?>"
                                        data-end-date="<?php echo date('Y-m-d'); ?>"><?php _e('All Time', 'simple-download-monitor'); ?></button>
                            </p>
                            <div class="submit">
                                <input type="submit" class="button-primary"
                                       value="<?php _e('View Stats', 'simple-download-monitor'); ?>">
                            </div>
                        </form>
                    </div>
                </div>
                <div class="nav-tab-wrapper sdm-tabs">
                    <a href="edit.php?post_type=sdm_downloads&page=stats&sdm_active_tab=datechart"
                       class="nav-tab<?php echo($active_tab == 'datechart' ? ' nav-tab-active' : ''); ?>"
                       data-tab-name="datechart"><?php _e('Downloads by date', 'simple-download-monitor'); ?></a>
                    <a href="edit.php?post_type=sdm_downloads&page=stats&sdm_active_tab=geochart" href=""
                       class="nav-tab<?php echo($active_tab == 'geochart' ? ' nav-tab-active' : ''); ?>"
                       data-tab-name="geochart"><?php _e('Downloads by country', 'simple-download-monitor'); ?></a>
                    <a href="edit.php?post_type=sdm_downloads&page=stats&sdm_active_tab=countrylistchart" href=""
                       class="nav-tab<?php echo($active_tab == 'countrylistchart' ? ' nav-tab-active' : ''); ?>"
                       data-tab-name="countrylistchart"><?php _e('Downloads by country list', 'simple-download-monitor'); ?></a>
                </div>
                <div class="sdm-tabs-content-wrapper" style="height: 500px;margin-top: 10px;">
                    <div data-tab-name="datechart"
                         class="sdm-tab"<?php echo($active_tab == 'datechart' ? '' : ' style="display:none;"'); ?>>
                        <div id="downloads_chart" style="width: auto; max-width: 700px"></div>
                    </div>
                    <div data-tab-name="geochart"
                         class="sdm-tab"<?php echo($active_tab == 'geochart' ? '' : ' style="display:none;"'); ?>>
                    ...
                    <div data-tab-name="countrylistchart"
                         class="sdm-tab"<?php echo($active_tab == 'countrylistchart' ? '' : ' style="display:none;"'); ?>>
                        <div class="wrap">
                            <table class="widefat">
                                <thead>
    ...
    <script>
        ...
        function sdm_drawDateChart() {
            ...
            sdm_dateChart.draw(sdm_dateData, {
                width: 'auto',
                height: 300,
                title: '<?php _e('Downloads by Date', 'simple-download-monitor'); ?>',
                colors: ['#3366CC', '#9AA2B4', '#FFE1C9'],
