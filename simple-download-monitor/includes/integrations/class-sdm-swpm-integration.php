...
class SDM_SWPM_Integration {
	...
	public function setup_swpm_integration() {
		...
		if ( $is_swpm_access_control_enabled ) {
			...
			add_action( 'sdm_process_download_request', array( $this, 'check_sdm_download_process' ), 5, 2 );
			add_action( 'sdm_sf_process_download_request', array( $this, 'check_sdm_download_process' ), 5, 2 );
