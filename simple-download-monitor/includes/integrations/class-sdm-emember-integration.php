...
class SDM_eMember_Integration {
	...
	public function __construct() {
		...
		if ( is_plugin_active( 'wp-eMember/wp_eMember.php' ) ) {
			...
			add_action( 'sdm_file_protection_settings_updated', array( $this, 'update_eMember_integration_settings' ) );
			add_action( 'sdm_after_file_protection_settings_fields', array(
				$this,
	...
	public function setup_eMember_integration() {
		...
		if ( $is_swpm_access_control_enabled ) {
			...
			add_action( 'sdm_process_download_request', array( $this, 'check_download_process' ), 5, 2 );
			add_action( 'sdm_sf_process_download_request', array( $this, 'check_download_process' ), 5, 2 );
